...
?>
	...
	<div class="col-lg-3" id="interests">
		<h5 class="font-weight-bold">Your Interests</h5>
		<table class="table table-sm w-75 justify-content-center" id="interests-table mx-auto">
			<tbody>
			<tr>
				<th scope="row"></th>
				<td>Pop Music</td>
