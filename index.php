...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top">MeetAmour</a> 
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="profile-search.html">Find Your Match</a>
          </li>
      ...
      <div class="row h-100">
        <div class="col-lg-7 my-auto">
          <div class="header-content mx-auto">
            <h1 class="mb-5"><span style="background-color: #ffb7ed"><font color="white">&nbsp&nbspWelcome to MeetAmour&nbsp&nbsp</font></span></h1>
            <h2 class="mb-5"><span style="background-color: #ff70db"><font color="white"> &nbsp&nbspFind.&nbsp </span>&nbsp<span style="background-color: #ffb7ed">&nbsp Match. &nbsp</span> <span style="background-color: #ff70db">&nbsp&nbspDate.&nbsp&nbsp </span></font></h2>
            <a href="register.php" class="btn btn-outline btn-xl js-scroll-trigger">Sign up today!</a>
          </div>
        </div>
